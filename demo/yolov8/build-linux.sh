...
# Copy picture files to the model directory
PICTURE_DIR="../../${BUILD_DEMO_PATH}/../picture"
if [ -d "$PICTURE_DIR" ]; then
    echo "Copying picture files to model directory..."
    cp "$PICTURE_DIR"/* "$INSTALL_DIR/model/"
fi
