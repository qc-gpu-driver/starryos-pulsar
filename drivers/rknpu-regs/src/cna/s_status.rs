...
#[doc = "Field `STATUS_0` reader - 执行器 0 状态。0：空闲；1：正在执行；2：正在执行且执行器 1 等待执行；3：保留"]
pub type Status0R = crate::FieldReader;
#[doc = "Field `STATUS_1` reader - 执行器 1 状态。0：空闲；1：正在执行；2：正在执行且执行器 1 等待执行；3：保留"]
pub type Status1R = crate::FieldReader;
impl R {
    #[doc = "Bits 0:1 - 执行器 0 状态。0：空闲；1：正在执行；2：正在执行且执行器 1 等待执行；3：保留"]
    #[inline(always)]
    pub fn status_0(&self) -> Status0R {
        Status0R::new((self.bits & 3) as u8)
    }
    #[doc = "Bits 16:17 - 执行器 1 状态。0：空闲；1：正在执行；2：正在执行且执行器 1 等待执行；3：保留"]
    #[inline(always)]
