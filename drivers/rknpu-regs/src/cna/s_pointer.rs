...
#[doc = "Field `POINTER_PP_MODE` reader - Ping-pong 模式。0：按执行器切换（executer 0 完成后切到 1）；1：按指针切换（pointer 0 完成后切到 1）"]
pub type PointerPpModeR = crate::BitReader;
#[doc = "Field `POINTER_PP_MODE` writer - Ping-pong 模式。0：按执行器切换（executer 0 完成后切到 1）；1：按指针切换（pointer 0 完成后切到 1）"]
...
impl R {
    ...
    #[doc = "Bit 3 - Ping-pong 模式。0：按执行器切换（executer 0 完成后切到 1）；1：按指针切换（pointer 0 完成后切到 1）"]
    #[inline(always)]
