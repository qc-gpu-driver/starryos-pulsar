...
#[doc = "Field `POINTER_PP_EN` reader - 寄存器组 ping-pong 使能"]
pub type PointerPpEnR = crate::BitReader;
#[doc = "Field `POINTER_PP_EN` writer - 寄存器组 ping-pong 使能"]
pub type PointerPpEnW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `EXECUTER_PP_EN` reader - 执行器组 ping-pong 使能"]
pub type ExecuterPpEnR = crate::BitReader;
#[doc = "Field `EXECUTER_PP_EN` writer - 执行器组 ping-pong 使能"]
...
#[doc = "Field `EXECUTER` reader - 当前使用的寄存器组。0：组 0；1：组 1"]
...
impl R {
    ...
    #[doc = "Bit 16 - 当前使用的寄存器组。0：组 0；1：组 1"]
    #[inline(always)]
